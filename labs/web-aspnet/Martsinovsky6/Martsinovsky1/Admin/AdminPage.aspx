<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="Martsinovsky1.Admin.AdminPage" %>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownAddCategory" runat="server"
                    ItemType="Martsinovsky1.Models.Category"
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownRemoveProduct" runat="server"
                    ItemType="Martsinovsky1.Models.Product"
