...
namespace Martsinovsky1.Models
{
    public class ProductDatabaseInitializer : DropCreateDatabaseIfModelChanges<ProductContext>
    {
        ...
        private static List<Category> GetCategories()
        {
            ...
            {
                new Category { CategoryID = 1, CategoryName = "Машины" },
                new Category { CategoryID = 2, CategoryName = "Самолеты" },
                new Category { CategoryID = 3, CategoryName = "Грузовики" },
                new Category { CategoryID = 4, CategoryName = "Корабли" },
                new Category { CategoryID = 5, CategoryName = "Ракеты" },
                new Category { CategoryID = 6, CategoryName = "Новинки" }
            };
